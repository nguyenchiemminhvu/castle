#ifndef CASTLE_CALLBACKS_INPLACE_CALLBACK_REGISTRY_HPP
#define CASTLE_CALLBACKS_INPLACE_CALLBACK_REGISTRY_HPP
...
#endif // CASTLE_CALLBACKS_INPLACE_CALLBACK_REGISTRY_HPP
