...
// used at subscription time by variant-/tuple-like machinery.
...
// end_line<TChar>: compile-time end-of-line character set. Consumed by
// string trim/tokenise algorithms so they stay character-type-agnostic.
