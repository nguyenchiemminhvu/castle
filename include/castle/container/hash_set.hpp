...
public:
    ...
    // Later duplicate keys are ignored, matching std::unordered_set's
    // initializer_list ctor.
    hash_set(initializer_list<key_type> list) CASTLE_NOEXCEPT : table_()
    {
        CASTLE_ASSERT(list.size() <= N, CASTLE_ERROR_GENERIC("hash_set: initializer_list exceeds capacity")); // LCOV_EXCL_BR_LINE
...
#endif // CASTLE_CONTAINER_HASH_SET_HPP
