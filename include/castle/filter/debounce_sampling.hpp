...
// castle::callbacks::function - no heap, no virtual dispatch, no-op
// when left unset.
//
// Template parameters:
...
//   CallbackStorageSize        - function SBO size for each of the 4 callbacks
//   CallbackStorageAlignment   - function SBO alignment for each of the 4 callbacks
// ============================================================================
template <
