...
TEST(CoreTraitsTest, WhitespaceAndEndLineAndInPlaceTags)
{
    EXPECT_STREQ(cm::whitespace<char>::value, " \t\f\v");
    EXPECT_STREQ(cm::whitespace<wchar_t>::value, L" \t\f\v");
    EXPECT_STREQ(cm::end_line<char>::value, "\n\r");
    EXPECT_STREQ(cm::end_line<wchar_t>::value, L"\n\r");
