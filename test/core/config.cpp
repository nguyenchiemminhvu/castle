...
TEST(CoreConfigTest, InplaceStorageConstantsAreConsistent)
{
    ...
    static_assert(castle::inplace_alignment_default == alignof(castle::meta::max_align_t),
    ...
    EXPECT_EQ(castle::inplace_alignment_default, alignof(castle::meta::max_align_t));
