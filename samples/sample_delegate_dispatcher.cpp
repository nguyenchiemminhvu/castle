/**
 * Castle 2.0 sample: <castle/events/delegate_dispatcher.h>
 *
...
using sensor_ready_config = castle::events::event_tag_config<
    SensorReadyEvent,
    4U,
    void(uint16_t)>;
...
int main()
{
    using dispatcher_type = castle::events::delegate_dispatcher<sensor_ready_config>;
    dispatcher_type dispatcher;
    castle::callbacks::delegate_ptr<void(uint16_t)> callback{on_sensor_ready};
