...
{
    castle::callbacks::function<int(int)> callback(&increment_free);
...
{
    castle::callbacks::function_ct<&increment_free> callback;
...
{
    castle::callbacks::function_f<IncrementFunctor, int(int)> callback{IncrementFunctor{}};
...
{
    Receiver receiver;
    castle::callbacks::function_m<Receiver, int(int)> callback(receiver, &Receiver::increment);
